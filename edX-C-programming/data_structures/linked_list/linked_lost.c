...
//It has two integer fields x and y that represent 
//the coordinates of a point in a two-dimensional space, 
//and a pointer field next that points to the next point 
